...
namespace CRUDTests
{
    public class CountriesServiceTest
    {
        ...
        {
            //Arrange
            CountryAddRequest? request1 = _fixture.Build<CountryAddRequest>().With(temp => temp.CountryName, "Canada").Create();
            CountryAddRequest? request2 = _fixture.Build<CountryAddRequest>().With(temp => temp.CountryName, "Canada").Create();
        ...
        {
            //Arrange
            CountryAddRequest? country_add_request = _fixture.Build<CountryAddRequest>().Create();
            ...
            country_response_from_get.Should().BeEquivalentTo(country_response_from_add);
        }
        #endregion
    }
}
